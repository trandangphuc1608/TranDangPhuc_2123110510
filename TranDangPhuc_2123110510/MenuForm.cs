...
namespace TranDangPhuc_2123110510
{
    ...
    {
        // Constructor nhận username từ trang Login
        ...
        void Btn_Click(object sender, EventArgs e)
        {
            ...
            switch (baiSo)
            {
                ...
                case 25:
                    new Form25().ShowDialog();
                    break;

                case 26:
                    new Form26().ShowDialog();
                    break;

                case 27:
                    new Form27().ShowDialog();
                    break;

                case 28:
                    new Form28().ShowDialog();
                    break;

                case 29:
                    new Form29().ShowDialog();
                    break;

                case 30:
                    new Form30().ShowDialog();
                    break;

                case 31:
                    new Form31().ShowDialog();
                    break;

                default:
                    MessageBox.Show("Đây là bài số: " + baiSo);
                    break;
            }
        }
    }
